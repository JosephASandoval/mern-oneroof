...
class CommentIndexItem extends React.Component {
  ...
  render() {
    ...
    const deleteButton =
      ...
      Object.values(this.props.currentUser).length === 0 ? null : this.props
          .currentUser.user._id === comment.authorId ? (
        <button
    ...
    return <div className="indiv-comment">{displayComment}</div>;
  }
}

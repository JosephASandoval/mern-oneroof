        ...
        <div className="event-pic-and-info">
          <div>
            <img
              ...
              className="home-page-event-images"
            ></img>
          </div>

          <div className="home-page-event-details">
            <div className="home-page-event-name">
              <span className="header-event-trend">
                {this.props.event.name}
              </span>
            </div>
            <div>
              <span className="event-text">Date:</span>{" "}
              {Object.values(this.props.event.date).slice(0, 10)}
            </div>
            <div>
              <span className="event-text">From:</span>&nbsp;
              <span>
                {this.props.event.startTime} to {this.props.event.endTime}
              </span>
            </div>
            <div>
              <span className="event-text">End Time:</span>{" "}
              {this.props.event.endTime}
            </div>
            <div>
              <span className="event-text">Partcipating:</span>{" "}
              {this.props.count[this.props.event._id]}
            </div>
            <div>
          ...
          <div className="trending-event-button-container">
            {" "}

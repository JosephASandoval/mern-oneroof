...
import Event_button_container from "./event_button_container";
...
class EventIndex extends React.Component {
  ...
  handleEventRendering() {
    if (this.props.loggedIn) {
                  ...
                  <div className="event-index-parent">
                    <div className="event-index-parent-info">
                      ...
                      <div className="event-index-description-list">
                        ...
                        <div className="date-index">
                          Participating:&nbsp;
                          <span className="event-index-info">
                            {this.props.count[event._id]}
                          </span>
                        </div>
                        <div className="date-index">
                          From:&nbsp;
                        ...
                        <div className="date-index">
                          Location:&nbsp;
                          <span id="event-index-info">{event.location}</span>
                        </div>
                        {/* <div className="date-index">
                          Hosted by:&nbsp;
                          <span id="event-index-info">
                            {this.props.users[event.hostId].username}
                          </span>
                        </div> */}
                      </div>
                      <div className="index-button-container">
                        <Event_button_container event={event} />
                      </div>
                    </div>
                  </div>
                </li>
      ...
      return (
        <div className="index-events-container">
          <div id="index-header">
            <h1 className="index-title">All Events</h1>
          </div>
          <div className="hosting-events">
            <ul>
                  ...
                  <div className="event-index-parent">
                    <div className="event-index-parent-info">
                      ...
                      <div className="event-index-description-list-nonuser">
                        ...
                        {/* <div className="date-index">Hosted by:&nbsp;<span id="event-index-info">{this.props.users[event.hostId].username}</span></div> */}
                      </div>
                      <div className="index-signin-button">
                        {" "}
                        <span
                          className="index-signin-text"
                          onClick={() => this.props.openModal("eventLogIn")}
                        >
                          Login to Join
                        </span>{" "}
                      </div>
  ...
  render() {
    ...
    return <div>{this.handleEventRendering()}</div>;
  }
}

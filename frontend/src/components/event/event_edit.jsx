...
class EditEvent extends React.Component {
  ...
  handleSubmit(e) {
    ...
    this.props
      ...
      .then(() => this.props.history.push(`/events/${this.props.event._id}`))
      ...
      <div>
        <form className="event-edit-form">
          ...
          <div className="input-field-event-edit-container">
            ...
            {!selectedDay && (
              <label className="event-create-label">Choose a day</label>
            )}
          ...
          <div className="input-field-event-edit-container">
            <label className="event-create-label">End Time:&nbsp;&nbsp;</label>
            <input
              type="time"
              className="input-field-event-create"
          ...
          <div className="input-field-event-edit-container">
            <label className="event-create-label">Location:&nbsp;&nbsp;</label>
            <input
              type="text"
              className="input-field-event-create"
          ...
          <button className="host-event-button" onClick={this.handleSubmit}>
            Save Event
          </button>
          <div>
            <Link to="/profile">
